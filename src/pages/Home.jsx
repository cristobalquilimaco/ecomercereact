  ...
  return (
    <div className='search__product__info'>
      <div className='search__products'>
        ...
        <input className='input__search' ref={input} onChange={handleChangeInput} type="text" placeholder='search products' /><i onClick={handleChangeInput} className='bx bx-search-alt'></i>
        </div>
